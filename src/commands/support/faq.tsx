...
import { EQUICORD_SITE, SUPPORT_ALLOWED_CHANNELS } from "~/constants";
...
export const fetchFaq = makeCachedJsonFetch<Faq[]>(EQUICORD_SITE + "/faq.json");
...
defineCommand({
    name: "faq",
    aliases: ["f"],
    description: "Get an answer from the faq",
    usage: "[tag | query]",
