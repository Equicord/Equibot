...
1. Make sure you have the settings in the image below enabled.
...
[Settings Image (it's a dropdown menu)](https://equicord.org/assets/plugins/questify/settings.png)
